...
void RecurringManager::write2Binary(ofstream &out) const
{
    out.write((char*)&nextRecurringId, sizeof(nextRecurringId));

    writeArray2Binary(recurringList, out);
}

void RecurringManager::readFromBinary(ifstream &inp)
{
    inp.read((char*)&nextRecurringId, sizeof(nextRecurringId));
